...
declare function Wizard({ data, debug, warningBeforeUnload, exports, showIntro, styles, translations, showResetModal, schema, setData, tableOfContents, title, wizard }: Props): React.JSX.Element;
