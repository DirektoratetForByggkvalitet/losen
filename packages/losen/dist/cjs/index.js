...
const StyleContext = require$$0$1.createContext(styles);
function StyleProvider({ children, styles: styles$1 = {} }) {
    return jsxRuntime.jsx(StyleContext.Provider, Object.assign({ value: merge$2({}, styles, styles$1) }, { children: jsxRuntime.jsx("div", { children: children }) }));
}

const injectStyles = (WrappedComponent) => require$$0$1.forwardRef((props, ref) => {
    const styles = require$$0$1.useContext(StyleContext);
    return (jsxRuntime.jsx(WrappedComponent, Object.assign({}, props, { ref: ref, styles: styles })));
});
...
function Modal(props) {
    ...
    return (jsxRuntime.jsx(ReactModal, Object.assign({ aria: {
            labelledby: "heading",
            describedby: "full_description",
        }, ariaHideApp: false, isOpen: showModal && Object.keys(props.data).length !== 0, role: "dialog", shouldCloseOnEsc: true, onRequestClose: handleCloseModal, style: customStyle }, { children: jsxRuntime.jsxs(ModalBox, { children: [jsxRuntime.jsx(H1, Object.assign({ id: "heading" }, { children: "Vil du starte p\u00E5 nytt?" })), jsxRuntime.jsx(Lead, Object.assign({ id: "full_description" }, { children: "Veiviseren husker svarene fra ditt forrige bes\u00F8k." })), jsxRuntime.jsx(MainButton, Object.assign({ type: "button", onClick: handleCloseModal }, { children: "Fortsett" })), jsxRuntime.jsx("br", {}), jsxRuntime.jsx(SecondaryButton, Object.assign({ type: "button", onClick: handleRestart }, { children: "Start p\u00E5 nytt" }))] }) })));
}
var Modal$1 = reactRedux.connect((state) => ({ data: state[NAME] }), (dispatch) => redux.bindActionCreators({ resetData }, dispatch))(Modal);
...
function NavItem({ active = false, done = false, heading = "TITLE MISSING", id, index, setPage }) {
    return (jsxRuntime.jsxs(NavItem$1, Object.assign({ active: active, done: done, href: "#", onClick: (e) => {
            e.preventDefault();
            setPage(id);
        } }, { children: [jsxRuntime.jsx("div", { children: index }), jsxRuntime.jsxs("p", { children: [heading, active ? "" : jsxRuntime.jsx("span", { children: "Endre svar" })] })] })));
}

function NavReset(props) {
    return (jsxRuntime.jsx(SecondaryButton, Object.assign({ type: "button", onClick: () => {
            /* eslint no-alert: 0 */
...
var NavReset$1 = reactRedux.connect(null, { resetData })(NavReset);

function NavResult({ setPage, id, active = false }) {
    return (jsxRuntime.jsx(MainButton, Object.assign({ type: "button", "data-id": id, active: active, onClick: () => setPage(id) }, { children: "Vis resultat" })));
}
...
function LanguageSelector({ translations: translationsObject, currentLanguage, setLanguage }) {
    ...
    return (jsxRuntime.jsx(Simple, Object.assign({ padItems: true }, { children: [
            /**
            ...
            ...translations,
        ].map(({ key, name }) => (jsxRuntime.jsx(SmallButton, Object.assign({ disabled: key === currentLanguage, onClick: handleLanguageSelect(key) }, { children: name }), key))) })));
}
const mapStateToProps$3 = (state) => ({
    currentLanguage: getCurrentLanguage(state),
});
var LanguageSelector$1 = reactRedux.connect(mapStateToProps$3, { setLanguage })(LanguageSelector);

function Nav({ heading = "Missing page heading", page: currentPage, setPage, tableOfContents, showIntro, translations }) {
    const [tocExpanded, setTocExpanded] = require$$0$1.useState(true);
    const toggleToc = () => setTocExpanded(!tocExpanded);
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsxs(ToggleButton, Object.assign({ type: "button", onClick: toggleToc }, { children: [tocExpanded ? "Vis" : "Skjul", " alle steg"] })), jsxRuntime.jsxs(Nav$1, Object.assign({ tocExpanded: tocExpanded }, { children: [jsxRuntime.jsx(Title, Object.assign({ onClick: showIntro }, { children: heading })), tableOfContents.map((page, index) => page.type === "Result" ? (jsxRuntime.jsx(NavResult, { id: page.id, setPage: setPage, 
                        // TODO: These 👇 were passed, but wasn't being received by NavResult..
                        // heading={page.heading}
                        // done={!page.errors}
                        active: page.id === currentPage }, page.id)) : (jsxRuntime.jsx(NavItem, { id: page.id, index: index + 1, heading: page.heading, setPage: setPage, done: !page.errors, active: page.id === currentPage }, page.id))), jsxRuntime.jsx(NavReset$1, { showIntro: showIntro }), jsxRuntime.jsx(LanguageSelector$1, { translations: translations })] }))] }));
}
...
function Html({ id, text, inline, h2, h3 }) {
    ...
    if (h2) {
        ...
        return (jsxRuntime.jsx(H2, { id: id, inline: inline, dangerouslySetInnerHTML: { __html: text } }));
    }
    if (h3) {
        // eslint-disable-next-line react/no-danger
        return (jsxRuntime.jsx(H3, { id: id, inline: inline, dangerouslySetInnerHTML: { __html: text } }));
    }
    // eslint-disable-next-line react/no-danger
    return (jsxRuntime.jsx(StyledHtml, { id: id, inline: inline, dangerouslySetInnerHTML: { __html: text } }));
}
...
function CheckboxInput(_a) {
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Checkbox$1, { "aria-label": heading, type: "checkbox", name: name, id: id, onChange: onChange, disabled: disabled, checked: checked }), jsxRuntime.jsxs(Label, Object.assign({ htmlFor: id, warning: message === null || message === void 0 ? void 0 : message.warning, debug: debug }, { children: [jsxRuntime.jsxs("div", Object.assign({ "data-id": id }, { children: [jsxRuntime.jsxs("div", { children: [heading && !text ? heading : null, heading && text ? jsxRuntime.jsx(H3, { children: heading }) : null] }), text ? jsxRuntime.jsx(Html, { text: text }) : null] })), image && image.url ? jsxRuntime.jsx("img", { src: image.url, alt: image.alt }) : null] }))] }));
}
...
function Checkbox({ setData, heading, options, grid, disabled, property, debug, currentValue, data, update }) {
    ...
    return (jsxRuntime.jsxs(Fieldset, { children: [jsxRuntime.jsx(SRLegend, { children: heading }), options && options.length ? (jsxRuntime.jsx(OptionWrapper, Object.assign({ grid: grid }, { children: options.map((option) => {
                    const isDisabled = disabled || option.disabled;
                    return (require$$0$1.createElement(CheckboxInput, Object.assign({}, option, { data: data, disabled: isDisabled, key: `${property}:${option.value}`, debug: debug, checked: currentValue === null || currentValue === void 0 ? void 0 : currentValue[option.value], name: property, onChange: !isDisabled ? handleChange(property, option.value) : undefined })));
                }) }))) : null] }));
}
...
function ErrorIcon({ textFill = 'white', triangleFill = styles.color.red }) {
    ...
    return (jsxRuntime.jsx("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 38 38", "aria-label": label }, { children: jsxRuntime.jsxs("g", { children: [jsxRuntime.jsx("circle", { style: { fill: triangleFill }, cx: "19", cy: "19", r: "16" }), jsxRuntime.jsx("path", { style: { fill: textFill }, d: "M16.9,25.1c0-0.7,0.2-1.2,0.5-1.5s0.9-0.5,1.5-0.5c0.6,0,1.2,0.2,1.5,0.5s0.5,0.8,0.5,1.5\n            c0,0.6-0.2,1.1-0.5,1.5s-0.9,0.5-1.5,0.5c-0.7,0-1.2-0.2-1.5-0.5S16.9,25.7,16.9,25.1z M20.4,21.1h-2.9L17,9.6H21L20.4,21.1z" })] }) })));
}
...
function Evaluation({ data, testing, final, groupedSimple, happy, sad, showValue, unit, }) {
    ...
    if (showValue) {
        if (testedValue < 0) {
            return (jsxRuntime.jsx(StyledSum, Object.assign({ groupedSimple: groupedSimple, final: final }, { children: jsxRuntime.jsxs("div", { children: [sad, jsxRuntime.jsxs("span", Object.assign({ className: "sad" }, { children: [absTestedValue, " ", unit ? jsxRuntime.jsx(Html, { inline: true, text: unit }) : null] }))] }) })));
        }
        return (jsxRuntime.jsx(StyledSum, Object.assign({ groupedSimple: groupedSimple, final: final }, { children: jsxRuntime.jsxs("div", { children: [happy, jsxRuntime.jsxs("span", Object.assign({ className: "happy" }, { children: [testedValue, " ", unit ? jsxRuntime.jsx(Html, { inline: true, text: unit }) : null] }))] }) })));
    }
    if (testedValue < 0) {
        // sad case
        return (jsxRuntime.jsx(StyledSumResult, { children: jsxRuntime.jsx("div", Object.assign({ className: "sad" }, { children: sad })) }));
    }
    // happy case
    return (jsxRuntime.jsx(StyledSumResult, { children: jsxRuntime.jsx("div", Object.assign({ className: "happy" }, { children: happy })) }));
}
...
function ApprovalAreas({ areas, title }) {
    ...
    let heading;
    if (title) {
        heading = jsxRuntime.jsx(H3, { children: "Sentrale godkjenninger" });
    }
    return (jsxRuntime.jsxs("div", { children: [heading, jsxRuntime.jsx(TableContainer, { children: jsxRuntime.jsxs(Table$1, { children: [jsxRuntime.jsx("thead", { children: jsxRuntime.jsxs("tr", { children: [jsxRuntime.jsx("th", { children: "Funksjon" }), jsxRuntime.jsx("th", { children: "Fagomr\u00E5de" }), jsxRuntime.jsx("th", { children: "Tiltaksklasse" })] }) }), jsxRuntime.jsx("tbody", { children: areas.map((area, rowKey) => (jsxRuntime.jsxs("tr", { children: [jsxRuntime.jsx("td", { children: area.function }), jsxRuntime.jsx("td", { children: area.subject_area }), jsxRuntime.jsx("td", { children: area.grade })] }, rowKey))) })] }) })] }));
}
...
function Input({ heading, property, errors, disabled, currentValue, placeholder, autocomplete, inputType, setData, update, }) {
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(TextInput, { "aria-label": heading, "aria-invalid": (_a = errors === null || errors === void 0 ? void 0 : errors.validation) === null || _a === void 0 ? void 0 : _a.error, "aria-describedby": ((_b = errors === null || errors === void 0 ? void 0 : errors.validation) === null || _b === void 0 ? void 0 : _b.error) ? `${property}.error` : undefined, disabled: disabled, id: property, onChange: handleChange, placeholder: placeholder, autoComplete: autocomplete, type: inputType, validation: errors === null || errors === void 0 ? void 0 : errors.validation, value: currentValue }), ((_c = errors === null || errors === void 0 ? void 0 : errors.validation) === null || _c === void 0 ? void 0 : _c.error) && (jsxRuntime.jsxs(ErrorMessage, Object.assign({ role: "alert", id: `${property}.error` }, { children: [jsxRuntime.jsx(ErrorIcon, {}), " ", errors.validation.message] })))] }));
}
...
function VariableText({ data = {}, text = "" }) {
    ...
    // eslint-disable-next-line react/no-danger
    return jsxRuntime.jsx("div", { dangerouslySetInnerHTML: { __html: compiled(data) } });
}
...
function FetchOrd(props) {
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Input, Object.assign({}, props, { type: "Input", currentValue: currentValue === null || currentValue === void 0 ? void 0 : currentValue.orgid, setData: (property, value) => setData(property, { orgid: value }), update: update })), (currentValue === null || currentValue === void 0 ? void 0 : currentValue.dataOrg) ? (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("br", {}), jsxRuntime.jsxs(DL, Object.assign({ role: "status" }, { children: [jsxRuntime.jsx("dt", { children: "Firmaets navn" }), jsxRuntime.jsx("dd", { children: (_a = currentValue === null || currentValue === void 0 ? void 0 : currentValue.name) !== null && _a !== void 0 ? _a : '' }), jsxRuntime.jsx("dt", { children: "Adresse" }), jsxRuntime.jsx("dd", { children: (_b = currentValue === null || currentValue === void 0 ? void 0 : currentValue.address) !== null && _b !== void 0 ? _b : '' }), jsxRuntime.jsx("dt", { children: "Postnummer- og sted" }), jsxRuntime.jsxs("dd", { children: [(_c = currentValue === null || currentValue === void 0 ? void 0 : currentValue.postcode) !== null && _c !== void 0 ? _c : '', ' ', (_d = currentValue === null || currentValue === void 0 ? void 0 : currentValue.postplace) !== null && _d !== void 0 ? _d : ''] })] })), jsxRuntime.jsxs(Information$2, { children: [jsxRuntime.jsx(ErrorIcon, { triangleFill: 'black' }), jsxRuntime.jsx(Html, { text: information })] })] })) : null, jsxRuntime.jsx("div", { children: jsxRuntime.jsxs("div", { children: [loading && jsxRuntime.jsx(Loading, Object.assign({ role: "status" }, { children: "Laster inn data" })), !loading && (currentValue === null || currentValue === void 0 ? void 0 : currentValue.dataSG) ? (jsxRuntime.jsxs(Notice, { children: [jsxRuntime.jsx(H3, { children: jsxRuntime.jsx(VariableText, { text: SGheading, data: currentValue }) }), jsxRuntime.jsx(ApprovalAreas, { areas: (_e = currentValue === null || currentValue === void 0 ? void 0 : currentValue.validApprovalAreas) !== null && _e !== void 0 ? _e : [] }), jsxRuntime.jsx(VariableText, { text: SGtext, data: currentValue })] })) : null, !loading && !(currentValue === null || currentValue === void 0 ? void 0 : currentValue.dataSG) && (currentValue === null || currentValue === void 0 ? void 0 : currentValue.orgid) ? jsxRuntime.jsx(H3, { children: invalidapproval }) : null] }) }), jsxRuntime.jsx("div", { children: (currentValue === null || currentValue === void 0 ? void 0 : currentValue.invalidOrg) ? (jsxRuntime.jsxs(ErrorMessage, Object.assign({ role: "alert" }, { children: [jsxRuntime.jsx(ErrorIcon, {}), " ", invalidOrg] }))) : null })] }));
}

function Image$1({ id, debug, image: { url, alt }, text }) {
    return (jsxRuntime.jsxs(Figure, Object.assign({ "data-id": id, debug: debug }, { children: [jsxRuntime.jsx("img", { src: url, alt: alt }), jsxRuntime.jsx("figcaption", { children: text })] })));
}

function Image({ image = {} }) {
    if (Object.prototype.hasOwnProperty.call(image, 'url') && image.url) {
        return jsxRuntime.jsx("img", { src: image.url, alt: image.alt });
    }
    return null;
}

function Information$1({ debug, heading, id, text, warning, printonly, printhide, }) {
    return (jsxRuntime.jsx(TextBlock, Object.assign({ warning: warning, debug: debug, "data-id": id, printonly: printonly, printhide: printhide }, { children: jsxRuntime.jsxs(Information$2, { children: [jsxRuntime.jsx(ErrorIcon, { triangleFill: 'black' }), jsxRuntime.jsx(Html, { text: heading, h2: true }), jsxRuntime.jsx(Html, { text: text })] }) })));
}

function Missing({ type = "No type" }) {
    return jsxRuntime.jsxs("div", { children: ["Block missing: ", type] });
}
...
function Number$1({ heading, property, errors, disabled, currentValue, placeholder, autocomplete, setData, maximum, minimum, step = 1, unit, }) {
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(NumberInput, { "aria-label": heading, "aria-invalid": (_b = errors === null || errors === void 0 ? void 0 : errors.validation) === null || _b === void 0 ? void 0 : _b.error, "aria-describedby": describedBy.length > 0 ? describedBy.join(' ') : undefined, disabled: disabled, id: property, max: maximum, min: minimum, onChange: handleChange, autoComplete: autocomplete, placeholder: placeholder, step: step, type: "number", unit: unit, validation: errors === null || errors === void 0 ? void 0 : errors.validation, value: currentValue }), unit ? jsxRuntime.jsx(Html, { inline: true, id: `${property}.unit`, text: unit }) : null, ((_c = errors === null || errors === void 0 ? void 0 : errors.validation) === null || _c === void 0 ? void 0 : _c.error) && (jsxRuntime.jsxs(ErrorMessage, Object.assign({ role: "alert", id: `${property}.error` }, { children: [jsxRuntime.jsx(ErrorIcon, {}), " ", errors.validation.message] })))] }));
}
...
function RadioInput({ id, value, checked, debug, disabled, heading, image, messages, onChange, text = '', name }) {
    const message = messages === null || messages === void 0 ? void 0 : messages[0];
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Radio$1, { "aria-label": heading, type: "radio", name: name, id: id, value: value, checked: checked, disabled: disabled, onChange: onChange }), jsxRuntime.jsxs(Label, Object.assign({ htmlFor: id, warning: message === null || message === void 0 ? void 0 : message.warning, debug: debug }, { children: [jsxRuntime.jsxs("div", Object.assign({ "data-id": id }, { children: [jsxRuntime.jsxs("div", { children: [heading && !text ? heading : null, heading && text ? jsxRuntime.jsx(H3, { children: heading }) : null, message ? (jsxRuntime.jsx(SoftWarning, Object.assign({ warning: message.warning }, { children: message.message }))) : null] }), text ? jsxRuntime.jsx(Html, { text: text }) : null] })), image && image.url ? jsxRuntime.jsx("img", { src: image.url, alt: image.alt }) : null] }))] }));
}
...
function Radio({ property, heading, text, grid, options, disabled, clear, debug, setData, currentValue, data }) {
    ...
    return (jsxRuntime.jsxs(Fieldset, { children: [jsxRuntime.jsx(SRLegend, { children: heading }), jsxRuntime.jsx(OptionWrapper, Object.assign({ grid: grid }, { children: options.map((option) => {
                    const isDisabled = disabled || option.disabled;
                    return (require$$0$1.createElement(RadioInput, Object.assign({}, option, { data: data, debug: debug, key: `${property}:${option.value}`, name: property, "data-id": option.id, disabled: isDisabled, checked: currentValue === option.value, onChange: !isDisabled ? handleChange(property, option.value) : undefined })));
                }) }))] }));
}

function SelectOption({ id, value, heading, debug }) {
    return (jsxRuntime.jsxs("option", Object.assign({ value: value }, { children: [heading, debug ? ` (${id})` : null] })));
}
...
function Select({ setData, property, options, defaultOption, heading, currentValue, autocomplete, debug, data }) {
    ...
    return (jsxRuntime.jsx(SelectWrapper, { children: jsxRuntime.jsxs("select", Object.assign({ "aria-label": heading, value: currentValue, onChange: handleChange, autoComplete: autocomplete }, { children: [jsxRuntime.jsx("option", Object.assign({ value: NULL_VALUE }, { children: placeholder })), options.map(option => (require$$0$1.createElement(SelectOption, Object.assign({ data: data, debug: debug }, option, { key: option.value }))))] })) }));
}
...
function Signature() {
    return (jsxRuntime.jsx(PrintForm, { children: jsxRuntime.jsx(Signature$1, { children: jsxRuntime.jsx("div", { children: "Dato og signatur" }) }) }));
}
...
function SummaryDetails({ summary, details }) {
    return (jsxRuntime.jsxs(Details, { children: [jsxRuntime.jsx(Summary$1, { children: summary }), jsxRuntime.jsx(Html, { text: details })] }));
}
...
function Sum$2({ data, values, operations, minimum, groupedSimple, final, heading, unit, summary, details }) {
    ...
    return (jsxRuntime.jsxs(StyledSum, Object.assign({ groupedSimple: groupedSimple, final: final }, { children: [jsxRuntime.jsxs("div", { children: [heading, jsxRuntime.jsxs("span", { children: [sum, " ", unit ? jsxRuntime.jsx(Html, { inline: true, text: unit }) : null] })] }), summary && jsxRuntime.jsx(SummaryDetails, { summary: summary, details: details })] })));
}
...
function TableCell(props) {
    return jsxRuntime.jsx(TD, Object.assign({}, props));
}
...
function Table({ cells, debug, simple }) {
    return (jsxRuntime.jsx(TableContainer, Object.assign({ simple: simple }, { children: jsxRuntime.jsx("table", Object.assign({ "data-debug": debug }, { children: jsxRuntime.jsx("tbody", { children: cells.map((row, rowKey) => (jsxRuntime.jsx("tr", { children: row.map((cell, cellKey) => {
                        ...
                        return (require$$0$1.createElement(Cell, Object.assign({ "data-id": cell.id }, cellProps, { key: cellKey, simple: simple }),
                            jsxRuntime.jsx(Html, { text: cell.text })));
                    }) }, rowKey))) }) })) })));
}

function Text({ debug, heading, id, text, warning = false, printonly = false, printhide = false, }) {
    return (jsxRuntime.jsxs(TextBlock, Object.assign({ warning: warning, debug: debug, "data-id": id, printonly: printonly, printhide: printhide }, { children: [jsxRuntime.jsx(Html, { text: heading, h2: true }), ";", jsxRuntime.jsx(Html, { text: text })] })));
}
...
function Textarea(props) {
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Textarea$1, { "aria-label": heading, "aria-describedby": information ? `${property}.information` : undefined, placeholder: placeholder, value: currentValue, onChange: handleChange, autoComplete: autocomplete }), information && (jsxRuntime.jsxs(Information$2, Object.assign({ id: `${property}.information` }, { children: [jsxRuntime.jsx(ErrorIcon, { triangleFill: 'black' }), jsxRuntime.jsx(Html, { text: information })] })))] }));
}
...
function PureBlock(props) {
    ...
    if (props.type === "ErrorOk") {
        return (jsxRuntime.jsx("div", { children: props.children.map((block) => (jsxRuntime.jsx(ConnectedBlock, Object.assign({ "data-id": props.id, simple: props.simple, setPage: props.setPage, errorPages: props.errorPages, pages: props.pages }, block), block.id))) }));
    }
    if (props.type === "Group") {
        return (jsxRuntime.jsxs(SpecificBlock, Object.assign({ "data-id": props.id, debug: props.debug }, { children: [jsxRuntime.jsx(Html, { text: props.heading, h2: true }), jsxRuntime.jsx(Html, { text: props.text }), props.children.map((block) => (jsxRuntime.jsx(ConnectedBlock, Object.assign({ grouped: true, "data-id": props.id, simple: props.simple, setPage: props.setPage, errorPages: props.errorPages, pages: props.pages }, block), block.id))), props.summary && (jsxRuntime.jsx(SummaryDetails, { summary: props.summary, details: props.details }))] })));
    }
    if (props.type === "Error") {
        return (jsxRuntime.jsxs(StyledErrorBlock, Object.assign({ role: "alert", "data-id": props.id, debug: props.debug }, { children: [jsxRuntime.jsx(Html, { text: props.heading, h2: true }), jsxRuntime.jsx(Html, { text: props.text }), props.children.map((block) => (jsxRuntime.jsx(ConnectedBlock, Object.assign({ grouped: true, "data-id": props.id, simple: props.simple, setPage: props.setPage, errorPages: props.errorPages, pages: props.pages }, block), block.id)))] })));
    }
    if (!SpecificBlock$1) {
        return jsxRuntime.jsx(Missing, { type: props.type });
    }
    if (props.type === "Image" ||
        props.type === "Text" ||
        ...
        return (jsxRuntime.jsx(SpecificBlock$1, Object.assign({ grouped: props.grouped, groupedSimple: props.simple, debug: props.debug, "data-id": props.id }, props)));
    }
    return (jsxRuntime.jsx(SpecificBlock, Object.assign({ "data-id": props.id, id: props.property, debug: props.debug, grouped: props.grouped, groupedSimple: props.simple, disabled: props.disabled, type: props.type }, { children: jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Html, { text: props.heading, h2: true }), jsxRuntime.jsx(Html, { text: props.text }), jsxRuntime.jsx(Image, { image: props.image }), repeatQuestion(props.image, props.text) ? (jsxRuntime.jsx(Html, { text: props.heading, h3: true })) : (""), jsxRuntime.jsx(SpecificBlock$1, Object.assign({ debug: props.debug }, Object.assign(Object.assign({}, props), { validation: props.currentValue && props.validator
                        ? {
                            error: !new RegExp(props.validator.pattern).test(props.currentValue),
                            message: props.validator.error,
                        }
                        : {} }))), props.disabled && (jsxRuntime.jsxs(ErrorMessage, Object.assign({ role: "alert" }, { children: [jsxRuntime.jsx(ErrorIcon, {}), " ", props.errorDescription] }))), props.summary && (jsxRuntime.jsx(SummaryDetails, { summary: props.summary, details: props.details }))] }) })));
}
PureBlock.propTypes = {
...
const ConnectedBlock = reactRedux.connect((state, props) => ({
    data: state[NAME],
...
}), (dispatch) => redux.bindActionCreators({ setData }, dispatch))(PureBlock);

function Navigation({ nextPageIsResult, hasNext = false, hasPrevious = false, nextPage = () => { }, previousPage = () => { }, }) {
    return (jsxRuntime.jsxs(Nav$1, { children: [hasPrevious ? (jsxRuntime.jsx(NavButton$1, Object.assign({ type: "button", onClick: previousPage }, { children: "Forrige" }))) : null, hasNext ? (jsxRuntime.jsx(NavButton$1, Object.assign({ type: "button", next: true, onClick: nextPage }, { children: nextPageIsResult ? "Vis resultat" : "Neste" }))) : null] }));
}
...
function Page({ children = [], debug = false, details = "", firstPage, lastPage, heading = "Missing page heading", lead = "", nextPage, nextPageIsResult, pageid, previousPage, summary = "", }) {
    return (jsxRuntime.jsxs(Main, Object.assign({ debug: debug, "data-id": pageid, id: "main" }, { children: [jsxRuntime.jsx(H1, { children: heading }), jsxRuntime.jsx(Lead, { children: jsxRuntime.jsx(Html, { text: lead }) }), summary && jsxRuntime.jsx(SummaryDetails, { summary: summary, details: details }), children.map((block, index) => (jsxRuntime.jsx(ConnectedBlock, Object.assign({}, block), (hasProperty(block, 'id') && block.id) || index))), (!firstPage || !lastPage) && (jsxRuntime.jsx(Navigation, { nextPageIsResult: nextPageIsResult, hasPrevious: !firstPage, previousPage: previousPage, hasNext: !lastPage, nextPage: nextPage }))] })));
}
...
function ExportData({ data }) {
    ...
    return (jsxRuntime.jsx("div", { children: jsxRuntime.jsx(MainButton, Object.assign({ "aria-live": copied ? "assertive" : undefined, copied: copied, onClick: copyToClipboard }, { children: buttonText })) }));
}
const mapStateToProps$2 = (state, { exporter }) => ({
    data: exporter(getData(state)),
});
var ExportData$1 = reactRedux.connect(mapStateToProps$2)(ExportData);
...
function Value({ value, node }) {
    ...
    if (!node.optional && [null, undefined, ""].includes(value)) {
        return jsxRuntime.jsx(Value$1, Object.assign({ missing: true }, { children: "* M\u00E5 fylles ut" }));
    }
    if (node.options) {
        let values;
        if (typeof value === "object") {
        ...
        if (!node.optional && !values.length) {
            ...
            return jsxRuntime.jsx(Value$1, { children: "Ingen valgt" });
        }
        const commaSeparated = values.slice(0, -1);
        const lastOne = values.slice(-1)[0];
        // If only one value selected
        if (!commaSeparated.length) {
            return (jsxRuntime.jsx(Value$1, { children: jsxRuntime.jsx(Html, { inline: true, text: lastOne }) }));
        }
        // If more than one selected
        return (jsxRuntime.jsxs(Value$1, { children: [commaSeparated.join(", "), " og ", lastOne, "."] }));
    }
    return (jsxRuntime.jsxs(Value$1, { children: [value, " ", node.unit ? jsxRuntime.jsx(Html, { inline: true, text: node.unit }) : null] }));
}
...
function Sum$1({ node, node: { allMandatory, currentValue = {}, errors } }) {
    ...
    return (jsxRuntime.jsx("div", { children: jsxRuntime.jsxs(SpecificBlock, Object.assign({ grouped: true, smallMarginTop: true, error: allMandatory && errors.required }, { children: [jsxRuntime.jsxs("p", { children: [matchingItems === 0 && (jsxRuntime.jsx("strong", { children: "Du har ikke valgt noen alternativer, men for " })), matchingItems > 0 && (jsxRuntime.jsxs("strong", { children: ["Du har ", allMandatory && errors.required ? "kun" : "", " valgt", " ", numOfMatchingItemsInObject(currentValue, true), " av ", " ", node.options.length, " alternativer."] }))] }), node.options.map((item) => (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(CheckboxResultDisplay, { type: "checkbox", id: `${node.id}-${item.value}`, checked: currentValue[item.value] || false, readOnly: true }), jsxRuntime.jsx(Label, Object.assign({ htmlFor: `${node.id}-${item.value}` }, { children: jsxRuntime.jsx("div", { children: item.heading }) }))] }, `${node.id}-${item.value}`)))] })) }));
}
const ConnectedSum$1 = reactRedux.connect((state) => ({
    data: state[NAME],
}))(Sum$1);
Sum$1.propTypes = {
...
function FetchOrgSummary({ value: { address = "", name = "", orgid = "", postcode = "", postplace = "", validApprovalAreas } = {}, }) {
    ...
    return (jsxRuntime.jsxs(DL, { children: [jsxRuntime.jsx("dd", { children: orgid }), jsxRuntime.jsx("dt", { children: "Firmaets navn" }), jsxRuntime.jsx("dd", { children: name }), jsxRuntime.jsx("dt", { children: "Adresse" }), jsxRuntime.jsx("dd", { children: address }), jsxRuntime.jsx("dt", { children: "Postnummer- og sted" }), jsxRuntime.jsxs("dd", { children: [postcode, " ", postplace] }), jsxRuntime.jsx(ApprovalAreas, { areas: validApprovalAreas, title: true })] }));
}
...
function Sum({ node, data }) {
    ...
    if (!hasAllValues(values, data)) {
        return jsxRuntime.jsx(Value$1, Object.assign({ missing: true }, { children: "* Mangler verdi for utregning" }));
    }
    ...
    return jsxRuntime.jsx(Value$1, { children: sum });
}
const ConnectedSum = reactRedux.connect((state) => ({
    data: state[NAME],
}))(Sum);

function SoftError({ children }) {
    return (jsxRuntime.jsx(NodeSummary$1, { children: children.map((child) => {
            const heading = !isOfType(child, ['Result']) &&
                ((hasProperty(child, 'heading') && child.heading) ||
                    (hasProperty(child, 'text') && child.text));
            if (heading) {
                return (jsxRuntime.jsxs(ErrorMessage, Object.assign({ role: "alert" }, { children: [jsxRuntime.jsx(ErrorIcon, {}), " ", jsxRuntime.jsx(Html, { text: heading, inline: true })] })));
            }
            return null;
        }) }));
}
...
function Information({ text }) {
    if (text) {
        return (jsxRuntime.jsx(NodeSummary$1, { children: jsxRuntime.jsxs(Information$2, { children: [jsxRuntime.jsx(ErrorIcon, { triangleFill: "black" }), jsxRuntime.jsx(Html, { text: text })] }) }));
    }
    return jsxRuntime.jsx("p", { children: "TEXT MISSING" });
}
...
function NodeSummary({ node }) {
    if (isOfType(node, ["Error"])) {
        return jsxRuntime.jsx(SoftError, { children: node.children });
    }
    if (isOfType(node, ["Information"])) {
        return jsxRuntime.jsx(Information, { text: node.text });
    }
    if (isOfType(node, ["Group", "ErrorOk"])) {
        return (jsxRuntime.jsx("div", { children: node.children.map((child) => (jsxRuntime.jsx(NodeSummary, { value: child.currentValue, node: child }, child.id))) }));
    }
    ...
    return (jsxRuntime.jsxs(NodeSummary$1, { children: [jsxRuntime.jsx(Html, { text: node.heading, h3: true }), jsxRuntime.jsx(ValueSummary, { value: get$2(node, 'currentValue'), node: node }), errors.validation.error ? (jsxRuntime.jsxs(ErrorMessage, Object.assign({ role: "alert" }, { children: [jsxRuntime.jsx(ErrorIcon, {}), errors.validation.message] }))) : null, errors.disabled.length ? (jsxRuntime.jsxs(ErrorMessage, Object.assign({ role: "alert" }, { children: [jsxRuntime.jsx(ErrorIcon, {}), " ", errorDescription] }))) : null] }));
}
...
function PageSummary({ children = [], error, goToPage, heading }) {
    return (jsxRuntime.jsxs(PageSummary$1, Object.assign({ error: error }, { children: [jsxRuntime.jsxs(H2, { children: [heading, " ", jsxRuntime.jsx(SmallButton, Object.assign({ type: "button", onClick: goToPage }, { children: "Endre svar" }))] }), children.map((node, index) => (jsxRuntime.jsx(NodeSummary, { node: node }, hasProperty(node, 'id') ? node.id : index)))] })));
}

function Summary({ errorPages, setPage, pages = [] }) {
    return (jsxRuntime.jsx("div", { children: pages
            .filter(({ type }) => type === "Page")
            .map((page) => (hasProperty(page, 'id') ? jsxRuntime.jsx(PageSummary, Object.assign({ error: !!errorPages.find(({ id }) => page.id === id) ||
...
function PDFButton({ localStorageKey, pageHeading, pdfServiceUrl, }) {
    const [isDownloading, setIsDownloading] = require$$0$1.useState(false);
    const [errorMessage, setErrorMessage] = require$$0$1.useState(false);
    const handleClick = () => {
        if (isDownloading) {
            return;
        }
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsxs(MainButton, Object.assign({ type: "button", onClick: handleClick, disabled: isDownloading }, { children: [jsxRuntime.jsx("span", { children: isDownloading ? 'Lager PDF...' : 'Lagre som PDF' }, "text"), jsxRuntime.jsx(Spinner, { hidden: !isDownloading }, "spinner")] })), errorMessage && jsxRuntime.jsx("p", { children: "Noe gikk galt. Pr\u00F8v igjen." })] }));
}
...
function Result(props) {
    ...
    return (jsxRuntime.jsxs(Main, Object.assign({ result: true, debug: debug, "data-id": pageid, id: "main" }, { children: [jsxRuntime.jsx(H1, Object.assign({ result: true }, { children: resultHeading })), jsxRuntime.jsx(Lead, Object.assign({ result: true }, { children: jsxRuntime.jsx(Html, { text: resultLead }) })), children.map((_a) => {
                var block = __rest(_a, ["heading"]);
                return (require$$0$1.createElement(ConnectedBlock, Object.assign({}, block, { key: block.id, errorPages: errorPages, setPage: setPage, pages: schema })));
            }), jsxRuntime.jsxs(SpecificBlock, { children: [summaryTitle ? jsxRuntime.jsx(H1, Object.assign({ small: true }, { children: summaryTitle })) : jsxRuntime.jsx(H1, Object.assign({ small: true }, { children: title })), jsxRuntime.jsx(Summary, { errorPages: errorPages, setPage: setPage, pages: schema })] }), !incomplete && exporter ? (jsxRuntime.jsxs(TextBlock, { children: [jsxRuntime.jsx(H2, { children: "Takk for at du gjennomf\u00F8rte veiviseren!" }), jsxRuntime.jsx(Lead, { children: "Du kan kopiere svarene dine, eller skrive ut resultatsiden." })] })) : null, jsxRuntime.jsxs(Export, Object.assign({ exporter: exporter }, { children: [!incomplete && exporter && (exports === null || exports === void 0 ? void 0 : exports[exporter]) ? (jsxRuntime.jsx(ExportData$1, { exporter: exports[exporter] })) : null, pdfServiceUrl && localStorageKey ? (jsxRuntime.jsx(PDFButton, { pdfServiceUrl: pdfServiceUrl, localStorageKey: localStorageKey, pageHeading: resultHeading })) : (jsxRuntime.jsx(MainButton, Object.assign({ type: "button", onClick: printPage }, { children: "Skriv ut" })))] }))] })));
}
const mapStateToProps$1 = (state, { wizard }) => ({
    errorPages: getErrorPages(wizard.schema, state),
});
var Result$1 = reactRedux.connect(mapStateToProps$1)(Result);
...
const SkipLink = () => (jsxRuntime.jsx(SkipLink$1, Object.assign({ href: "#main" }, { children: "G\u00E5 til hovedinnhold" })));
...
function Wizard({ data = {
    ...
    const [pageId, setPageId] = require$$0$1.useState(data[NAME].page || wizard.schema[0].id);
    require$$0$1.useState(false);
    const [showResetModal, setShowResetModal] = require$$0$1.useState();
    const pageWrapper = require$$0$1.useRef(null);
...
${error}
    ...
    const nextPageIsResult = schema[pageIndex + 1]
        ...
        : false;
    return (jsxRuntime.jsx(StyleProvider, Object.assign({ styles: styles }, { children: jsxRuntime.jsxs(Wizard$2, { children: [showResetModal && jsxRuntime.jsx(Modal$1, { showIntro: showIntro }), jsxRuntime.jsxs(Grid, { children: [jsxRuntime.jsx(SkipLink, {}), jsxRuntime.jsx(Nav, { page: page === null || page === void 0 ? void 0 : page.id, setPage: setPage, heading: title, tableOfContents: tableOfContents, showIntro: showIntro, translations: translations }), jsxRuntime.jsx(FocusWrapper, Object.assign({ tabIndex: "-1", ref: pageWrapper }, { children: page && isOfType(page, ["Result"]) ? (jsxRuntime.jsx(Result$1, Object.assign({}, page, { debug: debug, pageid: page.id, wizard: wizard, title: title, schema: schema, setPage: setPage, exports: exports }))) : (page && isOfType(page, ["Page", "Error", "ErrorOk"]) && (jsxRuntime.jsx(Page, Object.assign({ firstPage: firstPage, lastPage: lastPage, nextPage: nextPage, previousPage: previousPage, debug: debug, nextPageIsResult: nextPageIsResult, pageid: page.id }, page)))) }))] })] }) })));
}
...
var Wizard$1 = reactRedux.connect(mapStateToProps, (dispatch) => redux.bindActionCreators({ setData }, dispatch))(Wizard);

exports.Primitives = index;
exports.StyleProvider = StyleProvider;
exports.Wizard = Wizard$1;
exports.dsl = index$3;
exports.state = index$2;
exports.track = track;
