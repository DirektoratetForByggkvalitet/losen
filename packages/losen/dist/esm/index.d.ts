 ...
 */
export type NodeType = "Page" | "Result" | "Error" | "ErrorOk" | "Group" | "Result" | "Answer" | "Image" | "Text" | "Branch" | "Reference" | "Checkbox" | "Radio" | "Select" | "Input" | "Number" | "Textarea" | "Cell" | "Heading" | "Table" | "FetchOrg" | "Evaluation" | "Information" | "Signature" | "Sum";
type ImageSrc = {
    url: string;
    alt: string;
    text?: string;
...
export type InputNodeBase<T extends NodeType> = NodeBase<T> & CommonOptions & {
    id: string;
    property: string;
};
...
export type Group = NodeBase<"Group"> & VisibilityFilter & {
    heading?: string;
    text?: string;
    children: Node[];
};
...
export type Textarea = InputNodeBase<"Textarea"> & WithValidator & {
    information?: string;
    placeholder?: string;
    optional?: boolean;
    autocomplete?: string;
};
export type Input = InputNodeBase<"Input"> & WithValidator & {
    placeholder?: string;
    optional?: boolean;
    disabled?: Expression;
    autocomplete?: string;
...
export type Number = InputNodeBase<"Number"> & WithValidator & {
    text?: string;
    placeholder?: string;
    disabled?: Expression;
    optional?: boolean;
...
export type FetchOrg = InputNodeBase<"FetchOrg"> & WithValidator & {
    source: string;
    text?: string;
    placeholder?: string;
    information?: string;
...
export type Table = NodeBase<"Table"> & CommonOptions & {
    cells: Array<Array<Cell | Heading>>;
    simple?: boolean;
};
export type Sum = InputNodeBase<"Sum"> & CommonOptions & {
...
export type Node = Page | Result | Error | ErrorOk | Group | Checkbox | Radio | Select | Input | Number | Textarea | Answer | Image | Cell | Heading | Table | Branch | FetchOrg | Reference | Text | Evaluation | Information | Signature | Sum;
/**
 * Renderable answer type has a boolean for the disabled prop
 * (after evaluation of the expression)
 */
export type RenderableAnswer = WithError<Omit<Answer, "disabled"> & {
    disabled?: boolean;
}>;
/**
...
export type RenderableError = WithError<Omit<Error, "children"> & {
    children: RenderableNode[];
}>;
export type RenderableErrorOk = WithError<Omit<ErrorOk, "children"> & {
    children: RenderableNode[];
}>;
export type RenderableResult = WithError<Omit<Result, "children"> & {
    children: RenderableNode[];
}>;
export type RenderablePage = WithError<Omit<Page, "children"> & {
    children: RenderableNode[];
}>;
 ...
 * easy to do..
 */
export type Render<T extends Node | RenderableNode> = ValidatedNode<Omit<ResolveDisabled<T>, "show" | "hide" | "test" | "hidden">> & {
    debug: boolean;
};
/**
 ...
 */
export type RenderWithData<T extends RenderableNode["type"], V = any> = Render<Extract<RenderableNode, {
    type: T;
