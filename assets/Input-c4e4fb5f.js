import{i as e,s as o}from"./inject-styles-a5bba7af.js";const r=e(o.input.attrs({type:"checkbox"})`${({styles:i})=>`
  position: absolute;
  opacity: 0;
  z-index: -1;
  line-height: 1.4;
...
`}`),n=e(o.input.attrs({type:"checkbox"})`${({styles:i})=>`
  position: absolute;
  opacity: 0;
  z-index: -1;
  line-height: 1.4;
...
`}`),d=e(o.input.attrs({type:"radio"})`${({styles:i})=>`
  position: absolute;
  opacity: 0;
  z-index: -1;
  line-height: 1.4;
...
`}`),l=e(o.input`${({styles:i,validation:t})=>`
  font-family: inherit;
...
`}`),p=e(o.input`${({styles:i,validation:t})=>`
  font-family: inherit;
