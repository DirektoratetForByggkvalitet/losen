import{i as t,s as n}from"./inject-styles-a5bba7af.js";const i=t(n.button`${({styles:o,disabled:r,copied:e})=>`
...
`}`),c=t(n.button`${({styles:o,disabled:r})=>`
  position: relative;
  appearance: none;
  font-family: ${o.font.body};
  font-size: ${o.text.body.fontSize};
