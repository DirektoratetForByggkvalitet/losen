...
# Primitives
The losen wizard design is implmented trough _primitives_. These are HTML elements styled by using [styled components](https://styled-components.com/) and inherit from the styles theme variables. Changing colors in the styles file will update the primitives accordingly. 
