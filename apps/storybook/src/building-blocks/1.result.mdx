...
<Meta title="Building blocks/Result" />
...
<Table>
  ...
  <tr>
    ...
    <td>
      ...
      result page, this property must be set to `Result`.
    </td>
    <td>Yes</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      The heading of the page. <strong>Required</strong> 
...
```
  ...
  <tr>
    ...
    <td>
      ...
      lead property works the same way and expects the same object structure.
    </td>
    <td></td>
  </tr>
  <tr>
    ...
    <td>
      Which exporter to use. Refers to the exports object prop passed to the
      Wizard component.
    </td>
    <td></td>
  </tr>
  <tr>
    ...
    <td>
      An array of nodes to show for this result page. The nodes can be of any
      type except `Page` and `Result`.
    </td>
    <td></td>
  </tr>
  {common.show}
